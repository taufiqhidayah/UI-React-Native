...
export default function MentorScreen() {
    ...
    const [people, setPeope] = useState([
        ...
        { id: '2', name: 'Toni', img: { uri: 'https://reactnative.dev/img/tiny_logo.png' }, work: 'Disney Creator', raised: '$578', follow: '65K', update: '5' },
        { id: '3', name: 'Toni', img: { uri: 'https://reactnative.dev/img/tiny_logo.png' }, work: 'Disney Creator', raised: '$578', follow: '65K', update: '5' },
        { id: '4', name: 'Toni', img: { uri: 'https://reactnative.dev/img/tiny_logo.png' }, work: 'Disney Creator', raised: '$578', follow: '65K', update: '5' },
        { id: '5', name: 'Toni', img: { uri: 'https://reactnative.dev/img/tiny_logo.png' }, work: 'Disney Creator', raised: '$578', follow: '65K', update: '5' },
        { id: '6', name: 'Toni', img: { uri: 'https://reactnative.dev/img/tiny_logo.png' }, work: 'Disney Creator', raised: '$578', follow: '65K', update: '5' },
    ])
